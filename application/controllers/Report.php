    ...
    public function downloadRekapAsuransi()
    {
        ...
        foreach ($listLintasan as $lintasan) {
            ...
            while ($record = mysqli_fetch_array($entryData)) {
                ...
                $sheet->setCellValue('H44', '=ROUND((H41*13,75)/100, 2)')->getStyle('H44')->getFont()->setBold(true);
                $sheet->setCellValue('I44', '=ROUND((I41*15,40)/100, 2)')->getStyle('I44')->getFont()->setBold(true);
