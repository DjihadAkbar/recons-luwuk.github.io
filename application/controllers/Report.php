    ...
    public function downloadRekapAsuransi()
    {
        ...
        foreach ($listLintasan as $lintasan) {
            ...
            $entryData = mysqli_query(
                ...
                sum(entry_data.DewasaEksekutifTJP) AS 'DewasaEksekutifTJP', sum(entry_data.BayiEksekutif TJP) AS 'BayiEksekutifTJP', sum(entry_data.DewasaBisnisTJP) AS 'DewasaBisnisTJP', sum(entry_data.BayiBisnisTJP) AS 'BayiBisnisTJP', sum(entry_data.DewasaEkonomiTJP) AS 'DewasaEkonomiTJP', sum(entry_data.BayiEkonomiTJP) AS 'BayiEkonomiTJP', sum(entry_data.BarangVolumeTJP) AS 'BarangVolumeTJP', sum(entry_data.BarangPendapatanTJP) AS 'BarangPendapatanTJP',
                sum(entry_data.Gol1TJP) as 'Gol1TJP', sum(entry_data.Gol2TJP) as 'Gol2TJP', sum(entry_data.Gol3TJP) as 'Gol3TJP', sum(entry_data.Gol4PenTJP) as 'Gol4PenTJP', sum(entry_data.Gol4BarTJP) as 'Gol4BarTJP', sum(entry_data.Gol5PenTJP) as 'Gol5PenTJP',sum(entry_data.Gol5BarTJP) as 'Gol5BarTJP',sum(entry_data.Gol6PenTJP) as 'Gol6PenTJP',sum(entry_data.Gol6BarTJP) as 'Gol6BarTJP',sum(entry_data.Gol7TJP) as 'Gol7TJP',sum(entry_data.Gol8TJP) as 'Gol8TJP',sum(entry_data.Gol9TJP) as 'Gol9TJP',
                sum(entry_data.Suplesi1DewasaTJP) as 'Suplesi1DewasaTJP', sum(entry_data.Suplesi2DewasaTJP) as 'Suplesi2DewasaTJP', sum(entry_data.Suplesi1AnakTJP) as 'Suplesi1AnakTJP', sum(entry_data.Suplesi2AnakTJP) as 'Suplesi2AnakTJP',
                
                sum(entry_data.DewasaEksekutifIW) AS 'DewasaEksekutifIW', sum(entry_data.BayiEksekutif IW) AS 'BayiEksekutifIW', sum(entry_data.DewasaBisnisIW) AS 'DewasaBisnisIW', sum(entry_data.BayiBisnisIW) AS 'BayiBisnisIW', sum(entry_data.DewasaEkonomiIW) AS 'DewasaEkonomiIW', sum(entry_data.BayiEkonomiIW) AS 'BayiEkonomiIW', sum(entry_data.BarangVolumeIW) AS 'BarangVolumeIW', sum(entry_data.BarangPendapatanIW) AS 'BarangPendapatanIW',
                sum(entry_data.Gol1IW) as 'Gol1IW', sum(entry_data.Gol2IW) as 'Gol2IW', sum(entry_data.Gol3IW) as 'Gol3IW', sum(entry_data.Gol4PenIW) as 'Gol4PenIW', sum(entry_data.Gol4BarIW) as 'Gol4BarIW', sum(entry_data.Gol5PenIW) as 'Gol5PenIW',sum(entry_data.Gol5BarIW) as 'Gol5BarIW',sum(entry_data.Gol6PenIW) as 'Gol6PenIW',sum(entry_data.Gol6BarIW) as 'Gol6BarIW',sum(entry_data.Gol7IW) as 'Gol7IW',sum(entry_data.Gol8IW) as 'Gol8IW',sum(entry_data.Gol9IW) as 'Gol9IW',
                sum(entry_data.Suplesi1DewasaIW) as 'Suplesi1DewasaIW', sum(entry_data.Suplesi2DewasaIW) as 'Suplesi2DewasaIW', sum(entry_data.Suplesi1AnakIW) as 'Suplesi1AnakIW', sum(entry_data.Suplesi2AnakIW) as 'Suplesi2AnakIW',
            ...
            $sheet->mergeCells('H44:J44')->getStyle('H44')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            $sheet->mergeCells('C46:E46')->getStyle('C46')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            $sheet->mergeCells('F46:G46')->getStyle('F46')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            $sheet->mergeCells('H46:J46')->getStyle('H46')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            $sheet->mergeCells('C47:E47')->getStyle('C47')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            $sheet->mergeCells('F47:G47')->getStyle('F47')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            $sheet->mergeCells('H47:J47')->getStyle('H47')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
