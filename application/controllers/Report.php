    ...
    public function downloadRekapAsuransi()
    {
        ...
        foreach ($listLintasan as $lintasan) {
            ...
            $entryData = mysqli_query(
                ...
                sum(DewasaEksekutifTJP) AS 'DewasaEksekutifTJP', sum(BayiEksekutifTJP) AS 'BayiEksekutifTJP', sum(DewasaBisnisTJP) AS 'DewasaBisnisTJP', sum(BayiBisnisTJP) AS 'BayiBisnisTJP', sum(DewasaEkonomiTJP) AS 'DewasaEkonomiTJP', sum(BayiEkonomiTJP) AS 'BayiEkonomiTJP',
                ...
                sum(DewasaEksekutifIW) AS 'DewasaEksekutifIW', sum(BayiEksekutifIW) AS 'BayiEksekutifIW', sum(DewasaBisnisIW) AS 'DewasaBisnisIW', sum(BayiBisnisIW) AS 'BayiBisnisIW', sum(DewasaEkonomiIW) AS 'DewasaEkonomiIW', sum(BayiEkonomiIW) AS 'BayiEkonomiIW',
