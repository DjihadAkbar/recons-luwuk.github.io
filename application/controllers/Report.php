    ...
    public function downloadRekapAsuransi()
    {
        ...
        foreach ($listLintasan as $lintasan) {
            ...
            $entryData = mysqli_query(
                ...
                sum(DewasaEksekutifTJP) AS 'DewasaEksekutifTJP', sum(BayiEksekutif TJP) AS 'BayiEksekutifTJP', sum(DewasaBisnisTJP) AS 'DewasaBisnisTJP', sum(BayiBisnisTJP) AS 'BayiBisnisTJP', sum(DewasaEkonomiTJP) AS 'DewasaEkonomiTJP', sum(BayiEkonomiTJP) AS 'BayiEkonomiTJP', sum(BarangVolumeTJP) AS 'BarangVolumeTJP', sum(BarangPendapatanTJP) AS 'BarangPendapatanTJP',
                sum(Gol1TJP) as 'Gol1TJP', sum(Gol2TJP) as 'Gol2TJP', sum(Gol3TJP) as 'Gol3TJP', sum(Gol4PenTJP) as 'Gol4PenTJP', sum(Gol4BarTJP) as 'Gol4BarTJP', sum(Gol5PenTJP) as 'Gol5PenTJP',sum(Gol5BarTJP) as 'Gol5BarTJP',sum(Gol6PenTJP) as 'Gol6PenTJP',sum(Gol6BarTJP) as 'Gol6BarTJP',sum(Gol7TJP) as 'Gol7TJP',sum(Gol8TJP) as 'Gol8TJP',sum(Gol9TJP) as 'Gol9TJP',
                
                sum(DewasaEksekutifIW) AS 'DewasaEksekutifIW', sum(BayiEksekutif IW) AS 'BayiEksekutifIW', sum(DewasaBisnisIW) AS 'DewasaBisnisIW', sum(BayiBisnisIW) AS 'BayiBisnisIW', sum(DewasaEkonomiIW) AS 'DewasaEkonomiIW', sum(BayiEkonomiIW) AS 'BayiEkonomiIW', sum(BarangVolumeIW) AS 'BarangVolumeIW', sum(BarangPendapatanIW) AS 'BarangPendapatanIW',
                sum(Gol1IW) as 'Gol1IW', sum(Gol2IW) as 'Gol2IW', sum(Gol3IW) as 'Gol3IW', sum(Gol4PenIW) as 'Gol4PenIW', sum(Gol4BarIW) as 'Gol4BarIW', sum(Gol5PenIW) as 'Gol5PenIW',sum(Gol5BarIW) as 'Gol5BarIW',sum(Gol6PenIW) as 'Gol6PenIW',sum(Gol6BarIW) as 'Gol6BarIW',sum(Gol7IW) as 'Gol7IW',sum(Gol8IW) as 'Gol8IW',sum(Gol9IW) as 'Gol9IW',
