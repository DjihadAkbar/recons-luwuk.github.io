                        ...
                        <div style="white-space:normal">
                                    ...
                                    // } else {
                                        if($firstDate == null || $firstDate == ''){
                                            ...
                                            echo "Total Pendapatan Pertanggal ". $firstDate . " " . date("F", strtotime($month)) . " " . $year . " s.d " . $lastDate . " " . date("F", strtotime($month)) . " " . $year;
                                        }
                                    ?> 
                        </div> 
                    </button>
                    ...
                    <button style="text-decoration:none; display: block; color: black;" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        ...
                        // } else {
                            if($firstDate == null || $firstDate == ''){
                                ...
                                echo "Jumlah Produksi Pertanggal ". $firstDate . " " . date("F", strtotime($month)) . " " . $year . " s.d " . $lastDate . " " . date("F", strtotime($month)) . " " . $year;
                            }
                        // }
                        ?>
                    </button>
