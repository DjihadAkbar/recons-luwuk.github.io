<?php
    ...
    $sheet->mergeCells('E7:A8')->getStyle('E7')->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
    ...
    $sheet->setCellValue('A1', 'Bukti Penyetoran');
    ...
    {
        $sheet->setCellValue('E2', $record['dayname(date)']);
        $sheet->setCellValue('E3', $record['date']);
        $sheet->setCellValue('E4', $record['harbour']);
        $sheet->setCellValue('E5', $record['route']);
    ...
    $sheet->getStyle('A1:J42')->applyFromArray($styleArray);
